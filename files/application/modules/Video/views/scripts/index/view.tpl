...
<div class="fb-like" data-layout="button_count" data-action="like" data-size="large" data-show-faces="false" data-share="false"></div>
  ...
  <div class="video_desc video_desc_value">
    <?php echo $this->video->description;?>
  </div>
    
    <?php 
    $plugin = new Blog_Plugin_Mobile();
    if( (!empty($this->video->description) &&  strlen($this->video->description) > 500) || $plugin->isMobile()): ?>
    <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <!-- Mobile 3rd - 250 -->
    <ins class="adsbygoogle"
         style="display:inline-block;width:250px;height:250px"
         data-ad-client="ca-pub-4061361351337345"
         data-ad-slot="7910436112"></ins>
    <script>
