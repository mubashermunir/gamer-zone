...
return array(
  ...
  array(
    'title' => 'Blog Body',
    'description' => 'Displays an blog\'s body on its profile.',
    'category' => 'Articles',
    'type' => 'Blogs',
    'name' => 'blog.profile-body',      
    'autoEdit' => true,
    'adminForm' => array(
    'elements' => array(
        array( 'textarea', 'mobihtml',
            array(
                'label' => 'HTML CODE FOR MOBILE after 3',
            )
        ),
        array( 'textarea', 'mobihtml2',
            array(
                'label' => 'HTML CODE FOR MOBILE after 6',
            )
        ),
        array( 'textarea', 'sitehtml',
            array(
                'label' => 'HTML CODE FOR DESKTOP',
            )
        ),
     ),
    ), 
